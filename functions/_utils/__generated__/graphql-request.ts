...
export type InsertProfileMutation = { __typename?: 'mutation_root', insert_profiles?: { __typename?: 'profiles_mutation_response', affected_rows: number } | null };
...
export type GetUserQuery = { __typename?: 'query_root', user?: { __typename?: 'users', id: any, userProviders: Array<{ __typename?: 'authUserProviders', accessToken: string }> } | null };


export const InsertProfileDocument = gql`
    mutation insertProfile($profile: profiles_insert_input!) {
  insert_profiles(objects: [$profile]) {
    affected_rows
  }
}
    `;
